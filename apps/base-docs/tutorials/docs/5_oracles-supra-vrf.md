...
Please refer to the [Supra documentation](https://docs.supra.com/oracles/dvrf/a-deeper-dive-into-supra-dvrf) for the latest steps on how to register your wallet for their service.
